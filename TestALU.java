...
public class TestALU {
	public static void main(String[] args) {
		...
		// So C must be less than A while A + C can't be bigger than the max number. 1 should work?
		boolean[] binC = {true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false};
		...
		// Correct result of binC + binA, no signed overflow
		boolean[] addCA = {true,true,true,true,false,true,true,true,false,false,false,true,false,true,false,false,false,true,true,false,false,false,true,false,false,false,false,false,false,false,true,false};

		// Correct result of binC - binA, with signed overflow
		boolean[] subCA = {true,true,false,false,true,false,false,false,true,true,true,false,true,false,true,true,true,false,false,true,true,true,false,true,true,true,true,true,true,true,false,true};
		...
		// inputA would be binC, and inputB would be binA and compare with addCA
